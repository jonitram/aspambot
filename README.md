...
- When talking to either of the digging duo in Pokemon Sword and Shield

## Setting up the Arduino

- Disclaimer: These instructions were written for Mac OSX in the context of an Arduino with an atmega16u2 chip
- Change the `minutes` variable to the number of minutes you would like the bot to spam the a button for at the top of `instructions.h` before making and flashing `Joystick.hex` to the Arduino
